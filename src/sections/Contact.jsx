      ...
      <div className="container">
        ...
        >
          ...
          <div className="contact__social-icons">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/kaylir-digitals/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* X (Twitter) */}
            <a href="https://twitter.com/kaylirdigitals" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="X">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
